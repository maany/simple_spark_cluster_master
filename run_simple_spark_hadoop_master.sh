...
docker run -it --rm -e "EXECUTION_ID=${EXECUTION_ID}" -v $(pwd)/:/component_repository simple_spark_cluster_master_sh_pre_config bash
...
DOCKER_RUN="$DOCKER_RUN simple_spark_hadoop_master"
